    ...
    <div style={{ background:"#0A0A0A", color:"#F0EDE8", minHeight:"100vh", fontFamily:"'Syne',sans-serif" }}>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .avis-card:hover{border-color:rgba(201,168,76,0.3);transform:translateY(-2px)}
      ...
      <section style={{ padding:"5rem 3rem", textAlign:"center", borderBottom:"0.5px solid #1A1A1A", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ fontSize:10, letterSpacing:"4px", textTransform:"uppercase", color:"#C9A84C", marginBottom:"1rem" }}>— Transformations réelles</div>
      ...
      <section style={{ padding:"5rem 3rem", borderBottom:"0.5px solid #1A1A1A" }}>
        <div style={{ fontSize:10, letterSpacing:"4px", textTransform:"uppercase", color:"#C9A84C", marginBottom:"0.8rem", textAlign:"center" }}>— Résultats clients</div>
      ...
      <section style={{ padding:"5rem 3rem", borderBottom:"0.5px solid #1A1A1A", background:"#080808" }}>
        <div style={{ fontSize:10, letterSpacing:"4px", textTransform:"uppercase", color:"#C9A84C", marginBottom:"0.8rem", textAlign:"center" }}>— Avis vérifiés</div>
          ...
          {AVIS.map((a,i) => (
            <div key={i} className="avis-card">
              <div style={{ display:"flex", gap:2, marginBottom:12 }}>
                {"★★★★★".split("").map((s,j) => <span key={j} style={{ color:"#C9A84C", fontSize:14 }}>{s}</span>)}
              </div>
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                ...
                <span style={{ fontSize:9, letterSpacing:"2px", textTransform:"uppercase", color:"#C9A84C", background:"rgba(201,168,76,0.08)", border:"0.5px solid rgba(201,168,76,0.2)", padding:"2px 8px", borderRadius:10 }}>Plan {a.plan}</span>
              </div>
            </div>
          ))}
        </div>
