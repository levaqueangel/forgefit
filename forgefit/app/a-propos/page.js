...
export default function APropos() {
  ...
  return (
    <div style={{
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context": "https://schema.org", "@type": "Person", "name": "Angel Levaque", "jobTitle": "Coach Fitness Personnel", "worksFor": {"@type": "Organization", "name": "APXFITNESS"}, "description": "Coach fitness independant avec +5 ans d experience et +200 clients transformes. Specialise en musculation, nutrition sportive et coaching en ligne personalise.", "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://apxfitness-brown.vercel.app"}/a-propos`, "email": "coach.apxfitness11@gmail.com", "knowsAbout": ["Musculation", "Nutrition sportive", "Prise de masse", "Seche", "Coaching en ligne", "Programmation periodisee"], "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "Formation coaching et nutrition sportive"}], "alumniOf": {"@type": "Organization", "name": "Formation coaching fitness"}})}} />
      <style>{`
