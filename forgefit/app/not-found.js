    ...
    <div style={{ background: "#0A0A0A", color: "#F0EDE8", minHeight: "100vh", fontFamily: "'Syne',sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
        <div style={{ textAlign: "center", maxWidth: 600 }}>
          ...
          {/* 404 géant */}
          <div className="a1" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(100px, 20vw, 180px)", fontWeight: 600, lineHeight: 1, marginBottom: "0.5rem", position: "relative" }}>
          ...
          <div className="a2" style={{ fontSize: 11, letterSpacing: "4px", textTransform: "uppercase", color: "#C9A84C", marginBottom: "1rem" }}>
            — Page introuvable
          </div>
          ...
          <h1 className="a3" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: 600, lineHeight: 1.2, marginBottom: "1rem" }}>
            Cette page n'existe<br />
            <em style={{ fontStyle: "italic", color: "#555" }}>pas encore.</em>
          </h1>
