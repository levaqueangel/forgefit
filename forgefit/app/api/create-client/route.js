...
<tr><td style="background:#111;padding:36px;">
  ...
  <div style="background:#0D0D0D;border:0.5px solid #242424;padding:24px;margin:24px 0;">
    ...
    <table style="width:100%;">
      <tr><td style="padding:8px 0;border-bottom:0.5px solid #242424;font-size:13px;color:#555;font-family:Arial,sans-serif;">Email</td><td style="padding:8px 0;border-bottom:0.5px solid #242424;font-size:13px;color:#E8C87A;font-family:Arial,sans-serif;text-align:right;">${email}</td></tr>
